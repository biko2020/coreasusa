...
<body>
	...
	<div class="page-wrapper">
		...
		<!-- Page Title -->
		<section class="page-title" style="background-image: url(/coreasusa/public/img/background/s-2.jpg)">
		...
		<section class="products-section">
			<div class="auto-container">
				<div class="sec-title centered">
					<div class="big-text">
						<?= $lang['location-back-text'] ?>
					</div>
					<div class="title">
						<?= $lang['location-products'] ?>
					</div>
					<h2>
						<?= $lang['location-title'] ?>
					</h2>
			...
			<div class="auto-container">
				...
				<div class="row clearfix">
					...
					<div class="approach-block col-lg-4 col-md-6 col-sm-12">
						<div class="inner-box wow fadeInLeft" data-wow-delay="0ms" data-wow-duration="1500ms">
							<div class="image">
								<a href="#"><img src="/coreasusa/public/img/products/c-02.jpg" alt="" /></a>
							</div>
							<div class="lower-content">
					...
					<div class="approach-block col-lg-4 col-md-6 col-sm-12">
						<div class="inner-box wow fadeInLeft" data-wow-delay="0ms" data-wow-duration="1500ms">
							<div class="image">
								<a href="#"><img src="/coreasusa/public/img/products/f-02.jpg" alt="" /></a>
							</div>
							<div class="lower-content">
								<h4><a href="#">Electric Forkilft</a></h4>
								<div class="text">Manufacturer: Hyster<br>
